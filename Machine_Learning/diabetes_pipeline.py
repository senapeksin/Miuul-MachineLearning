...
# Helper Functions
################################################
# Eğer utils ve helpers diye başka python dosyasında metotlarımızı bulundursaydık ve bu dosyaları çağırmak isteseydik;
# from helpers import * diyerek import ederdik.
